...
<head>
    ...
    <style>
        ...
        .table-container {
            max-width: 90%; /* Reduce table width */
            margin-right: 20px; /* Add right margin */
        }
        /* Custom styles for the modal position */
        .modal-backdrop.show {
            backdrop-filter: blur(80px); /* Increased blur effect */
            background-color: rgba(0, 0, 0, 0.7); /* Darken the backdrop */
        }
        .modal-dialog {
            position: fixed; /* Make the modal fixed */
            bottom: 5%; /* Position from the bottom */
            left: 45%; /* Position slightly towards the right */
            transform: translate(-50%, 0); /* Center horizontally */
            margin: 0; /* Remove default margins */
            max-width: 800px; /* Increased maximum width for the modal */
            width: 100%; /* Use full width up to the max width */
        }
        .modal-content {
            min-width: 400px; /* Set a minimum width for the modal */
            height: auto; /* Allow height to adjust automatically */
        }
        .form-row {
            display: flex; /* Align form fields in a row */
            justify-content: space-between; /* Space between fields */
        }
        .form-row .form-group {
            width: 48%; /* Adjust width of each field */
        }
    </style>
</head>
<body>
    ...
    <div class="sidebar">
        ...
        <a href="/admin/dashboard" id="usersLink"><i class="bi bi-people me-2"></i> Users</a>
    ...
    <div class="content">
        ...
        <nav class="navbar navbar-light bg-light mb-4">
            <div class="container-fluid d-flex flex-column align-items-start">
                <h3 class="mb-0" style="color: black; font-weight: bold;">Welcome, Admin!</h3>
            </div>
        </nav>
